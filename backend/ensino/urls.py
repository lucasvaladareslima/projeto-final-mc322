...
from ensino.views.turma_view import TurmaCreateView, TurmaListView, TurmasAlunoListView, TurmasProfessorListView
...
urlpatterns = [
    ...
    path('publicacao/tarefas-pendentes/',
         TarefasPendentesListView.as_view(), name='tarefas-pendentes-list'),
    path('periodo-letivo/', PeriodoLetivoListView.as_view(),
         name='periodo-letivo-list'),
    path('turma/', TurmaListView.as_view(), name='turma-list'),
    path('turma/aluno/<int:aluno_id>/',
         TurmasAlunoListView.as_view(), name='turmas-aluno-list'),
    path('turma/professor/<int:professor_id>/',
         TurmasProfessorListView.as_view(), name='turmas-professor-list'),
    path('turma/cadastrar/', TurmaCreateView.as_view(), name='turma-cadastrar'),
    path('disciplina/cadastrar/', DisciplinaCreateView.as_view(),
         name='disciplina-cadastrar'),
    path('periodo-letivo/cadastrar/', PeriodoLetivoCreateView.as_view(),
         name='periodo-letivo-cadastrar'),
    path('publicacao/material/cadastrar/',
         MaterialCreateView.as_view(), name='material-cadastrar'),
    path('publicacao/tarefa/cadastrar/',
         TarefaCreateView.as_view(), name='tarefa-cadastrar'),
    path('publicacao/anuncio/cadastrar/',
         AnuncioCreateView.as_view(), name='anuncio-cadastrar'),
    path('publicacao/entrega-tarefa/cadastrar/',
         EntregaTarefaCreateView.as_view(), name='entrega-tarefa-cadastrar'),
]
