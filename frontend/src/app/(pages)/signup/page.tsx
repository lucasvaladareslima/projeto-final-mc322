  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        const errorMessage =
          errorData[firstErrorKey]?.[0] || "Falha ao realizar o cadastro.";
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              disabled={isLoading}
              className="w-full rounded-lg border-gray-300 bg-gray-50 p-3 text-black text-gray-900 placeholder-gray-400 focus:border-sky-500 focus:ring-sky-500 disabled:bg-gray-200"
            />
          </div>
          <div>
